...
<html>
	...
	<body class="landing" onload="triggerSite()">
				...
				<div class="container">
					<header class="major">
						...
						<p>Das folgende Experiment besteht aus zwei Abschnitten: Einer kurzen Interaktion mit einem Chatbot, das heißt einer Software mit welcher Sie über natürliche Sprache kommunizieren können, und einer anschließenden Umfrage.
							Das Ziel der Interaktion mit dem Chatbot ist es, ein Rätsel zu lösen, indem dem Chatbot Ja-Nein-Fragen gestellt werden.
							Nachdem Sie das Rätsel lösen konnten, erhalten sie den Link zu der Umfrage.</br></br>
